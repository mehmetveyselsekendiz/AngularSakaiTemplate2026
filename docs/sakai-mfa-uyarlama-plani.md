...
Yeni Claude Code oturumunda **`docs/yeni-sakai-session-prompt.md`** dosyasını oku ve ilk mesaj olarak yapıştır. **Tamamlanan:** Phase 0–8. **Aktif faz:** Phase 9 — Bileşen Kodunu Görüntüleme/Kopyalama. Faz ilerlemesi için [`ilerleme-ve-kararlar.md`](ilerleme-ve-kararlar.md).
